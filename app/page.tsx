...
export default function Home() {
  ...
  return (
    <section>
      <h1 className="text-2xl font-bold mb-7">Matt Simpson</h1>
      ...
      <p className="prose prose-neutral dark:prose-invert prose-a:underline-offset-2 prose-a:decoration-neutral-400 hover:prose-a:decoration-neutral-900 prose-a:transition-colors prose-a:duration-200">
        Let&apos;s hang out{" "}
        <a
